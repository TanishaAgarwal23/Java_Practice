...
public class Lab4_3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            emp.display();
            emp.writeToFile("C:\\Users\\Tanisha.Agarwal\\eclipse-workspace\\Testing_Project\\src\\test\\java\\pack1\\employee.txt");
            System.out.println("\nEmployee details written to file.");
            Employee empFromFile = Employee.readFromFile("C:\\Users\\Tanisha.Agarwal\\eclipse-workspace\\Testing_Project\\src\\test\\java\\pack1\\employee.txt");
